...
export type IClockRotation = {
  type: ClockRotationType;
  minutes: number;
  hours: number;
};

export let MAX_SPINS: number = 3;
export let MIN_SPINS: number = 1;

export let ClockRotations: Map<ClockRotationType, IClockRotation> = new Map<
  ClockRotationType,
  IClockRotation
>([
  ...
  [
    ClockRotationType.D,
    { type: ClockRotationType.D, minutes: 270, hours: 180 },
  ],
  ...
  [
    ClockRotationType.I,
    { type: ClockRotationType.I, minutes: 180, hours: 315 },
  ],
  [ClockRotationType.J, { type: ClockRotationType.J, minutes: 180, hours: 45 }],
  [
    ClockRotationType.K,
    { type: ClockRotationType.K, minutes: 225, hours: 225 },
  ],
]);
